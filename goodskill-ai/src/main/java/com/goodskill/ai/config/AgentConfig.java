...
import com.goodskill.ai.tool.SeckillQueryTool;
...
public class AgentConfig {
	...
	@Bean
	public ToolCallback querySeckillTool(SeckillQueryTool seckillQueryTool) {
		return FunctionToolCallback.builder("query_seckill_detail", seckillQueryTool)
				.description("查询秒杀商品详情，根据秒杀活动ID查询商品的名称、库存数量、价格、活动状态、开始结束时间等信息")
				.inputType(SeckillQueryTool.QueryRequest.class)
				.build();
	}

  ...
  try {
    ...
    if (response.data.code === 0) {
      ...
      for (const product of records) {
        if (product.photoUrl) {
          if (product.photoUrl.startsWith('http') || product.photoUrl.startsWith('data:')) {
  ...
  try {
    ...
    if (response.data.code === 0) {
      ...
      if (productForm.value.photoUrl) {
        if (productForm.value.photoUrl.startsWith('http') || productForm.value.photoUrl.startsWith('data:')) {
